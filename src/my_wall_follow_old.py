...
#    black_board.scan.header.seq = msg.header.seq
#    black_board.scan.header.stamp = msg.header.stamp
#    black_board.scan.header.frame_id = msg.header.frame_id
#    black_board.scan.angle_min = msg.angle_min
#    black_board.scan.angle_max = msg.angle_max
#    black_board.scan.angle_increment = msg.angle_increment
#    black_board.scan.time_increment = msg.time_increment
#    black_board.scan.scan_time = msg.scan_time
#    black_board.scan.range_min = msg.range_min
#    black_board.scan.range_max = msg.range_max
#
#    black_board.scan.intensities = msg.intensities
    
    black_board.scan = list(msg.ranges)
    pdb.set_trace()
...
#    rospy.Publisher('/scan', sensor_msgs.msg.LaserScan, queue_size=10).publish(black_board.scan)
    ...
    line = fit_line(black_board.scan, 0, n-1, black_board.maximum_range)
    print line
    lines = ExtractedLines()
    lines.header.frame_id = '/laser'
